    ...
    <section id="mobile-app-section" className="relative overflow-hidden min-h-[450px] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          ...
          alt="Paysage fond" 
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[var(--brand-dark)] via-[rgb(var(--brand-dark-rgb)/95%)] to-[rgb(var(--brand-dark-rgb)/30%)]"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end items-center mt-12 lg:mt-0">
            <div className="absolute -z-10 flex flex-wrap gap-4 w-[400px] justify-center opacity-80">
                <div className="w-16 h-16 bg-[var(--brand-dark-hover)] rounded-2xl flex items-center justify-center transform -rotate-12 shadow-xl border border-white/10">
                    <Ship className="text-white/60" size={32} />
                </div>
                <div className="w-20 h-20 bg-[var(--brand-dark)] rounded-2xl flex items-center justify-center transform rotate-6 shadow-2xl translate-y-8 border border-white/20">
                    <Box className="text-white/80" size={40} />
                </div>
                <div className="w-14 h-14 bg-[var(--brand-accent)] rounded-xl flex items-center justify-center transform -rotate-6 shadow-lg -translate-x-12 border border-white/10">
            ...
            <div className="relative w-full max-w-[280px] transform rotate-[12deg] shadow-[20px_40px_60px_rgba(0,0,0,0.5)] rounded-[2.5rem] border-[8px] border-black overflow-hidden hover:rotate-0 transition-transform duration-700 ease-out">
               <img
                 src={settings.appPreviewImageUrl ?? undefined}
                 alt="Nagode App Preview"
                 className="w-full h-auto"
               />
               <div className="absolute inset-0 bg-[rgb(var(--brand-dark-rgb)/10%)] pointer-events-none"></div>
            </div>
            ...
            <div className="absolute -bottom-4 right-10 md:right-20 bg-white p-3 rounded-2xl shadow-2xl animate-bounce hidden md:block">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] font-bold text-[var(--brand-dark)] uppercase">Nagode App</p>
